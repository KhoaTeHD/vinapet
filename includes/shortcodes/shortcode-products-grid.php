...
class VinaPet_Products_Shortcode {
    ...
    private function print_css() {
        ...
        .vinapet-product-card:nth-child(1) { animation-delay: 0.05s; }
        .vinapet-product-card:nth-child(2) { animation-delay: 0.10s; }
        .vinapet-product-card:nth-child(3) { animation-delay: 0.15s; }
        .vinapet-product-card:nth-child(4) { animation-delay: 0.20s; }
        .vinapet-product-card:nth-child(5) { animation-delay: 0.25s; }
        .vinapet-product-card:nth-child(6) { animation-delay: 0.30s; }
        .vinapet-product-card:nth-child(7) { animation-delay: 0.35s; }
        .vinapet-product-card:nth-child(8) { animation-delay: 0.40s; }
